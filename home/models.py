...
class Sensors(models.Model):
    ...
    #__Sensors_FIELDS__
    temperature_setpoint_auto = models.IntegerField(null=True, blank=True)
    temperature_setpoint_manual = models.IntegerField(null=True, blank=True)
    temperature_measured = models.IntegerField(null=True, blank=True)
